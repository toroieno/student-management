  ...
  <div class="container">
    <div class="filter-form container">
      <v-row>
        ...
        <v-select
          :items="items"
          label="Phân loại theo loại đồ án"
        ></v-select>
        </v-col>
        <v-col
          cols="12"
    ...
    <v-data-table
      :headers="headers"
      :items="projects"
      sort-by="form_register_project.time_register"
      sort-desc=false
      class="elevation-1"
    >
      <template v-slot:top>
        <v-toolbar
          flat
        >
          <v-toolbar-title>Danh sách thông tin đăng ký đồ án</v-toolbar-title>
          <v-divider
            class="mx-4"
            inset
            vertical
          ...
          <v-dialog v-model="dialogDelete" max-width="500px">
            <v-card>
              <v-card-title class="text-h5">Bạn muốn xoá thông tin sinh viên này?</v-card-title>
              <v-card-actions>
                <v-spacer></v-spacer>
  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Loại đồ án', value: 'type_project' },
        { text: 'Họ và tên sinh viên', value: 'form_register_project.student.full_name' },
        { text: 'Họ và tên giảng viên', value: 'lecturer.full_name' },
        { text: 'Thời gian đăng ký', value: 'form_register_project.time_register' },
