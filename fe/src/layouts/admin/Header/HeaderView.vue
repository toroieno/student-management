      ...
      nudge-bottom="10">
        <template v-slot:activator="{ on, attrs }">
          <v-btn
            ...
            <v-icon
              style="font-size: 28px"
              :color="light.iconColor">mdi-account</v-icon>
            </v-btn>
        </template>
        <v-list >
          ...
          <v-list-item-group color="primary">
            <v-list-item
              ...
              :key="i">
                ...
                <v-list-item-content>
                  <v-list-item-title :color='light.textColor' v-text="item.text"></v-list-item-title>
                </v-list-item-content>
            </v-list-item>
          </v-list-item-group>
          <div class="d-flex justify-center my-3">
...
import SearchBar from "@/layouts/admin/Search/SearchBar";
